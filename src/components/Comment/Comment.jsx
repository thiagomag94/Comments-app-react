...
const Comment = (props) => {
    ...
    const {name, email, message, hour, minutes, onDeleteComment} = props;
    ...
    return (
        ...
        <div id="div-comment"  className="w-11/12 mb-12 text-sm flex flex-col justify-center items-center bg-neutral-800 rounded-lg drop-shadow-sm gap-4 relative py-4 pb-6 px-4 flex-wrap relative lg:w-2/5 ">
            ...
            <p className="text-slate-400 font-extralight absolute right-4 bottom-2 opacity-40"> {new Date().toLocaleDateString()} às <span>{hour}h:{minutes}</span></p>
