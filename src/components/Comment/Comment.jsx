...
const Comment = (props) => {
    ...
    return (
        ...
        <div id="div-comment"  className="w-full mb-12 text-sm flex flex-col justify-center items-center bg-neutral-800 rounded-lg drop-shadow-sm gap-4 relative py-4 pb-6 px-4 flex-wrap relative md:w-11/12 lg:w-2/5 ">
            <p className="text-primary-color  py-2">{name}<span className="text-slate-200 font-extralight text-sm "> - {email}</span></p>
            <div className="w-4/5 mb-10 text-slate-400 font-extralight p-10 rounded-lg"><p align="justify">{message}</p></div>    
