...
const Comment = (props) => {
    ...
    return (
        ...
        <div className="w-11/12 text-sm flex flex-col justify-center items-center bg-neutral-800 rounded-lg shadow-xl gap-4 relative py-4 pb-6 px-4">
            ...
            <button className="text-lg absolute top-0 right-2 cursor-pointer" onClick = {onDeleteComment}>&#10006;</button>
